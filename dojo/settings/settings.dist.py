...
DEDUPLICATION_ALLOWED_ATTRIBUTES = ['title', 'cwe', 'endpoints', 'offset', 'line', 'file_path', 'sourcefile', 'param', 'url']
...
DEDUPLICATION_ALGORITHM_PER_PARSER = {
    ...
    'AA DEWANGI': DEDUPE_ALGO_WSO2_CUSTOM,
    'AA': DEDUPE_ALGO_WSO2_CUSTOM
}
